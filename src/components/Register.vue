	...
	<form>
		<div class="container">
				...
				<div class="field">
					...
					<div class="control">
						<input v-model="email" v-bind:class="{'is-danger' : missingEmail, input, is-rounded}" type="text" name="email" required placeholder="Email">
				...
				<div class="field">
					...
					<div class="control">
						<input v-model="password" v-bind:class="{'is-danger' : wrongPassword, input, is-rounded}" type="password" name="psswd" required placeholder="Mot de passe">
